<%@ page import="java.util.List, chen_yi_an.User, chen_yi_an.Wallet, chen_yi_an.TransactionLog, java.util.ArrayList" %>
...
<body>
    ...
    <div class="container mt-4" style="max-width: 720px;">
        ...
        <% } %>
        <% if (loginUser == null) { %>
            <div class="alert alert-info">请先 <a href="${pageContext.request.contextPath}/login">登录</a> 以查看钱包信息</div>
        <% } %>
        ...
        <div class="balance-card mb-4">
            <div class="row text-center">
                <div class="col-4">
                    ...
                    <div class="balance-amount">¥<%= wallet != null ? String.format("%.2f", wallet.getBalance()) : "0.00" %></div>
                </div>
                <div class="col-4">
                    <div class="balance-label">托管冻结</div>
                    <div class="balance-amount">¥<%= wallet != null ? String.format("%.2f", wallet.getFrozen()) : "0.00" %></div>
                </div>
                <div class="col-4">
                    <div class="balance-label">总资产</div>
                    <div class="balance-amount">¥<%= wallet != null ? String.format("%.2f", wallet.getBalance() + wallet.getFrozen()) : "0.00" %></div>
                </div>
            </div>
        </div>
