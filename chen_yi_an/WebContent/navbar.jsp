<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="chen_yi_an.User" %>
<%
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="<%= ctx %>/deliveryChat">聊天</a></li>
            </ul>
            <ul class="navbar-nav">
                <% if (navUser != null) { %>
